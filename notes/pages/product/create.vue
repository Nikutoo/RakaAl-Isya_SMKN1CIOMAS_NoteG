...
const formCreateProduct = [
  { name: "name", label: "Judul", type: "text", value: "", placeholder: "Buat Judul Catatanmu...", required: true },
  { name: "description", label: "Isi", type: "text", value: "", placeholder: "Isi Catatanmu Disini.....", required: true },
  { name: "image", label: "Gambar", type: "file", value: {}, placeholder: ""},
];
...
<template>
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      <h1 class="text-2xl mb-7 font-medium">Buat Catatan Baru</h1>
